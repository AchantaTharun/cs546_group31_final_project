...
if (eventForm) {
  eventForm.addEventListener("submit", (event) => {
    ...
    let totalNumberOfAttendees = document.getElementById(
    ...
    try {
      ...
      if (parseInt(maxCapacity) - parseFloat(maxCapacity) !== 0)
        throw "Max Capcity invalid";
      ...
      if (parseInt(totalNumberOfAttendees) > parseInt(maxCapacity))
